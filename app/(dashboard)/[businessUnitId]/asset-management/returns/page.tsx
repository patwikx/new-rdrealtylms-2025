...
import { AssetReturnView } from "@/components/asset-management/asset-return-view"

interface AssetReturnPageProps {
  params: Promise<{
...
export default async function AssetReturnPage({ params, searchParams }: AssetReturnPageProps) {
  ...
  try {
    ...
    // Get deployed assets for return
    ...
    console.error("Error loading asset return page:", error)
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Asset Returns</h1>
          </div>
        </div>
